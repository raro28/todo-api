...
public interface TaskListApi {
    @Operation(summary = "Gets a paginated list of task lists", tags = {"lists", "crud"}, security = @SecurityRequirement(name = "oAuth2", scopes = "read"))
    ...
    @Operation(summary = "Deletes a task list by its id", tags = {"lists", "crud"}, security = @SecurityRequirement(name = "oAuth2", scopes = "write"))
    ...
    @Operation(summary = "Gets a task list by its id", tags = {"lists", "crud"}, security = @SecurityRequirement(name = "oAuth2", scopes = "read"))
    ...
    @Operation(summary = "Replaces an existing task list", tags = {"lists", "crud"}, security = @SecurityRequirement(name = "oAuth2", scopes = "write"))
    ...
    @Operation(summary = "Gets a paginated list of tasks related to an existing task list", tags = {"lists", "tasks", "crud"}, security = @SecurityRequirement(name = "oAuth2", scopes = "write"))
    ...
    @Operation(summary = "Creates a new task on an existing task list", tags = {"lists", "tasks", "crud"}, security = @SecurityRequirement(name = "oAuth2", scopes = "write"))
    ...
    @Operation(summary = "Creates a new task list", tags = {"lists", "crud"}, security = @SecurityRequirement(name = "oAuth2", scopes = "write"))
